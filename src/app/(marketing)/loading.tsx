          ...
          <div className="container mx-auto px-[16px]">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-[48px] items-center">
              <div className="space-y-[20px]">
                <div className="h-[14px] w-[200px] bg-white/10 rounded-full animate-pulse" />
                <div className="space-y-[12px]">
                  <div className="h-[48px] md:h-[64px] w-[80%] bg-white/10 rounded-[12px] animate-pulse" />
                  <div className="h-[48px] md:h-[64px] w-[60%] bg-white/10 rounded-[12px] animate-pulse" />
                  <div className="h-[48px] md:h-[64px] w-[40%] bg-white/10 rounded-[12px] animate-pulse" />
                </div>
                <div className="h-[60px] w-full bg-white/5 rounded-[12px] animate-pulse" />
