export default function MatchesResultsLoading() {
  return (
    <div>
      <div className="mb-[24px]">
        <div className="h-[28px] w-[180px] bg-gray-100 rounded animate-pulse mb-[4px]" />
        <div className="h-[14px] w-[260px] bg-gray-50 rounded animate-pulse" />
      </div>
        ...
        {Array.from({ length: 5 }).map((_, i) => (
          <div key={i} className="bg-white rounded-[14px] p-[16px] border border-gray-100 animate-pulse">
            <div className="flex items-center justify-between">
              ...
              <div className="h-[24px] w-[80px] bg-gray-100 rounded" />
              <div className="flex items-center gap-[12px]">
                <div className="w-[32px] h-[32px] bg-gray-100 rounded-full" />
                <div className="space-y-[6px]">
                  <div className="h-[13px] w-[140px] bg-gray-100 rounded" />
